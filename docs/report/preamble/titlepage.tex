...
\begin{tikzpicture}[overlay,remember picture]
       ...
       node[midway,left=0.25cm,text width=5cm,align=right,black!75]
              {\fontsize{25}{30}\selectfont \textbf{#5}}
       node[midway,right=0.25cm,text width=6cm,align=left,orange]
              {\fontsize{72}{86}\selectfont #4};

       \node[align=center] at ($(current page.center)+(0,-7)$)
       {\fontsize{36}{72}\selectfont\textbf{#1} \\[5cm]
              \fontsize{16}{19}\selectfont\textcolor{orange}{\textbf{#2}} \\[3pt]
              \large #3};
\end{tikzpicture}%
}
