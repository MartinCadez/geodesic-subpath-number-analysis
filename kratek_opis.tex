...
Za delo z grafi in njihovo reprezentacijo bomo uporabili Python knjižnico \textit{NetworkX}. Za generiranje grafov brez trikotnikov bomo uporabili \textit{SageMath}, ki omogoča delo z bolj kompleksnimi grafi in njihovo analizo.
