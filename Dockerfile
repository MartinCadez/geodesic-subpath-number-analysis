...
RUN echo 'export PATH="/home/sage/sage/local/var/lib/sage/venv-python3.12.5/bin:$PATH"' >> ~/.bashrc && \
    ...
    echo 'cd /home/sage/sage/repo/' >> ~/.bashrc

RUN /home/sage/sage/local/var/lib/sage/venv-python3.12.5/bin/pip install --no-cache-dir -r /home/sage/sage/repo/requirements.txt
